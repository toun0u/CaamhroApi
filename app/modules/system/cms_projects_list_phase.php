...
while ($fields = $db->fetchrow($rs)) {
	...
	/* Front É: Si la personnes n'est pas assigné sur a la tache, elle n'y a pas accès */
	...
	//else
		echo '<td class="tds" >'.$fields['label'].'</td>';

	/* On récupère la valeur des champs. Si celle-ci est vide on le signale */
	echo "<td class=\"tds\" >".$fields['label_parent']."</td>";
