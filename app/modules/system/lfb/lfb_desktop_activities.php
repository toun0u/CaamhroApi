<div style="width:100%;">
	...
	<tr>
		<td style="width:60%;height:60px;" valign="top">
			<?php
				echo $skin->open_simplebloc($_DIMS['cste']['_DIMS_LABEL_ACTIVITY'], '', '', '');
			?>
			<div style="width:100%;height:160px;display:block;">
				...
				<span style="width: 100%; display: block; float: left;">
					...
					$sql_pmod = "	SELECT			distinct c.firstname, c.lastname, c.id as id_pers, c.timestp_modify,
									...
									ON				u.id = c.id_user_create
									WHERE			c.timestp_modify >= :datesince
									AND				c.inactif != 1
					...
					$sql_pmod = "	SELECT			t.intitule, t.id as id_tiers, t.timestp_modify, t.ville,
									...
									INNER JOIN		dims_mod_business_contact c
									ON				c.id = u.id_contact
									WHERE			t.timestp_modify >= :datesince
									AND				t.inactif != 1
					...
					switch ($nb_resp) {
						case 0:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/add_view.png\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=contact_new\">".$_DIMS['cste']['_DIMS_LABEL_NO_NEW_SHEET']."</a></span></td>";
							break;
						case 1:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/add_view.png\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=contact_new\">".$nb_resp." ".$_DIMS['cste']['_DIMS_LABEL_NEW_SHEET_SINCE_ONCE']." </a></span></td>";
							break;
						default:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/add_view.png\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=contact_new\">".$nb_resp." ".$_DIMS['cste']['_DIMS_LABEL_NEW_SHEET_SINCE']."</a></span></td>";
							break;
					}
					...
					switch ($nb_resp_ent) {
						case 0:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/add_view.png\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=ent_new\">".$_DIMS['cste']['_DIMS_LABEL_NO_NEW_SHEET']."</a></span></td>";
							break;
						case 1:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/add_view.png\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=ent_new\">".$nb_resp_ent." ".$_DIMS['cste']['_DIMS_LABEL_NEW_SHEET_SINCE_ONCE']." </a></span></td>";
							break;
						default:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/add_view.png\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=ent_new\">".$nb_resp_ent." ".$_DIMS['cste']['_DIMS_LABEL_NEW_SHEET_SINCE']."</a></span></td>";
							break;
					}
					echo"</tr><tr>";
					...
					switch ($nb_respmod) {
						case 0:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/edity.gif\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=contact_modify\">".$_DIMS['cste']['_DIMS_LABEL_NO_MODIFY_SHEET']."</a></span></td>";
							break;
						case 1:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/edit.gif\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=contact_modify\">".$nb_respmod." ".$_DIMS['cste']['_MODIFY_SHEET_SINCE_ONCE']." </a></span></td>";
							break;
						default:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/edit.gif\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=contact_modify\">".$nb_respmod." ".$_DIMS['cste']['_MODIFY_SHEET_SINCE']."</a></span></td>";
							break;
					}
					...
					switch ($nb_respmod_ent) {
						case 0:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/edit.gif\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=ent_modify\">".$_DIMS['cste']['_DIMS_LABEL_NO_MODIFY_SHEET']."</a></span></td>";
							break;
						case 1:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/edit.gif\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=ent_modify\">".$nb_respmod_ent." ".$_DIMS['cste']['_MODIFY_SHEET_SINCE_ONCE']." </a></span></td>";
							break;
						default:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/edit.gif\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=ent_modify\">".$nb_respmod_ent." ".$_DIMS['cste']['_MODIFY_SHEET_SINCE']."</a></span></td>";
							break;
					}
					echo"</tr><tr>";

					// fiches en veille
					$sql_f = "SELECT * FROM dims_mod_business_ct_watch WHERE id_user = :userid and id_tiers>0";
					$res_f = $db->query($sql_f, array(
						':userid' => $_SESSION['dims']['userid']
					));
					...
					switch ($nb_veille) {
						case 0:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/view.png\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=contact_veille\">".$_DIMS['cste']['_DIMS_LABEL_VEILLE_NO_FICH']."</a></span></td>";
							break;
						case 1:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/view.png\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=contact_veille\">".$nb_veille." ".$_DIMS['cste']['_DIMS_LABEL_VEILLE_FICH_ONCE']." </a></span></td>";
							break;
						default:
							echo "<td><span style=\"width:16px;margin-right:4px;display:block;float:left;\"><img src=\"./common/img/view.png\" alt=\"\"></span><span style=\"float:left;\"><a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=contact_veille\">".$nb_veille." ".$_DIMS['cste']['_DIMS_LABEL_VEILLE_FICH']."</a></span></td>";
							break;
					}
		...
		<td style="width:40%;height:60px;"	valign="top">
			<?php
				$title='';
				...
				<span style="width: 100%; display: block; float: left;clear:both;">
					<?
						...
						if ($db->numrows($ressource)>0) {
							echo "<a href=\"".$dims->getScriptEnv()."?dims_action=public&dims_mainmenu=0&submenu=".dims_const::_DIMS_SUBMENU_ACTIVITIES."&action=events\">".$db->numrows($ressource)." ".$_DIMS['cste']['_DIMS_LABEL_EVENTS']."</a>";
						}
						else {
		...
		<td colspan="2">
			...
			switch($action) {
				case 'tags':
					...
					break;
				case 'contact_new':
					$fileinclude=DIMS_APP_PATH . '/modules/system/lfb_desktop_activities_contact.php';
				...
				case 'contact_veille':
					...
					break;
				case 'ent_new':
					$fileinclude=DIMS_APP_PATH . '/modules/system/lfb_desktop_activities_ent.php';
					$title=$_DIMS['cste']['_DIMS_LABEL_NEW_SHEET_SINCE']." ".strtolower($_DIMS['cste']['_DIMS_LABEL_SINCE'])." ".$date_since;
					break;
				case 'ent_modify':
					$fileinclude=DIMS_APP_PATH . '/modules/system/lfb_desktop_activities_ent.php';
