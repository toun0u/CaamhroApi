...
<table width="100%" cellpadding="0" cellspacing="3">
	...
	<tr>
		<td colspan="3">
			...
			<div id="affiche_link_met" style="display:block;width:100%;">
				<form name="form_inscript_link" id="scp form_inscript_link" action="<?php echo $dims->getScriptEnv(); ?>" method="post">
                <?
                ...
                ?>
                <? } ?>
                <input type="hidden" name="type" value="ent_ent"/>
                    <table width="100%" border="0" cellpadding="5" cellspacing="0">
                        <tr>
                            ...
                            <td align="left">
                                <input type="text" value="" onkeyup="javascript:upKeysearchLink('ent_ent');" id="search_tiers" name="search_tiers"/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
	...
	<tr>
		<td colspan="3" align="center">
			<?
			echo dims_create_button($_DIMS['cste']['_DIMS_LABEL_CANCEL'],'./common/img/undo.gif',"javascript:affiche_div('zone_addent');affiche_div('button_addent');document.getElementById('dispres_searchp').innerHTML='';document.getElementById('dispres_searcht').innerHTML='';",'','');
			?>
		</td>
	</tr>
</table>
