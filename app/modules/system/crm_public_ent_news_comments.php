...
$sql_com = "SELECT		*
			...
			WHERE		id_contact =".$ent->fields['id']."
			AND			id_object =".dims_const::_SYSTEM_OBJECT_TIERS."
			ORDER BY	date_create DESC";

$res_com = $db->query($sql_com);
while($tab_res = mysql_fetch_assoc($res_com)) {
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr>
		...
		<? echo $skin->open_simplebloc($_DIMS['cste']['_DIMS_COMMENTS'], "", "padding-left:15px;", "./common/img/widget_zoom.png", "26", "26", "-15px", "0px", "javascript:void(0);", "javascript:affiche_div('last_comm');", ""); ?>
				...
				<tr>
					<td align="center">
						...
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr>
								<td colspan="3">
									<div id="affiche_com_1" style="display:block;width:100%;height:<? if(!empty($tab_com['generique']['current'])) echo "160px"; else echo "50px"; ?>;overflow:auto;">
										<table cellspacing="0" cellpadding="0" width="100%" style="margin-top:10px;margin-bottom:10px;">
											<tbody>
												<tr>
													...
													<td align="center">
														<a href="javascript:void(0);" onclick="javascript:modComment('<? if(isset($tab_com['generique']['current']['id'])) echo $tab_com['generique']['current']['id']; else echo ''; ?>', '<? echo $ent->fields['id']; ?>', '<? if(empty($tab_com['generique']['current']['id'])) echo '1'; else echo ''; ?>');">
															<img src="./common/img/add.gif" title="<?php echo $_DIMS['cste']['_DIMS_TITLE_ADD_COMM']?>"/>
														</a>
														<?
															if(isset($tab_com['generique'])) {
																if($_SESSION['dims']['userid'] == $tab_com['generique']['current']['id_user']) {
														?>
																	<a href="javascript:void(0);" onclick="javascript:modCommentbyAuthor('<? if(isset($tab_com['generique']['current']['id'])) echo $tab_com['generique']['current']['id']; else echo ''; ?>', '<? echo $ent->fields['id']; ?>', '<? if(empty($tab_com['generique']['current']['id'])) echo '1'; else echo ''; ?>');">
								...
								<td class="midb20" style="font-size:13px;">
									<table width="100%" cellpadding="0" cellspacing="0" style="color:#fff;font-size:13px;">
										<tr>
											...
											<td style="padding-bottom:4px;padding-left:4px;" align="left">
												<?
													echo $_DIMS['cste']['_DIMS_LABEL_COMMENT_MET'];
												?>
											</td>
										</tr>
									</table>
						...
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr>
								<td colspan="3">
									<div id="affiche_com_2" style="display:block;width:100%;height:<? if(!empty($tab_com['metier']['current'])) echo "160px"; else echo "50px"; ?>;overflow:auto;">
										<table cellspacing="0" cellpadding="0" width="100%" style="margin-top:10px;margin-bottom:10px;">
											<tbody>
												<tr>
													<td width="90%" style="border:#738CAD 1px solid;padding:3px;">
													...
													<td align="center">
														<a href="javascript:void(0);" onclick="javascript:modComment('<? if(isset($tab_com['metier']['current']['id'])) echo $tab_com['metier']['current']['id']; else echo ''; ?>', '<? echo $ent->fields['id']; ?>', '<? if(empty($tab_com['metier']['current']['id'])) echo '2'; else echo ''; ?>');">
															<img src="./common/img/add.gif" title="<?php echo $_DIMS['cste']['_DIMS_TITLE_ADD_COMM']?>"/>
														</a>
														<?
															if(isset($tab_com['metier'])) {
																if($_SESSION['dims']['userid'] == $tab_com['metier']['current']['id_user']) {
														?>
														<a href="javascript:void(0);" onclick="javascript:modCommentbyAuthor('<? if(isset($tab_com['metier']['current']['id'])) echo $tab_com['metier']['current']['id']; else echo ''; ?>', '<? echo $ent->fields['id']; ?>', '<? if(empty($tab_com['metier']['current']['id'])) echo '2'; else echo ''; ?>');" title="<? echo $_DIMS['cste']['']; ?>">
															<img src="./common/img/edit.gif" title="<?php echo $_DIMS['cste']['_DIMS_TITLE_MODIFY_COMMENTAIRE']?>"/>
														</a>
														<?		}
															}
						...
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr>
								<td colspan="3">
									<div id="affiche_com_3" style="display:none;width:100%;height:<? if(!empty($tab_com['perso']['current'])) echo "160px"; else echo "50px"; ?>;overflow:auto;">
										<table cellspacing="0" cellpadding="0" width="100%" style="margin-top:10px;margin-bottom:10px;">
											<tbody>
												<?
													if(!empty($tab_com['perso']['current'])) {
														$date_writed = dims_timestamp2local($tab_com['perso']['current']['date_create']);
														echo '<tr><td colspan="2">'.$date_writed['date'].'</td></tr>';
													}
												?>
												<tr>
													<td width="90%" style="border:#738CAD 1px solid;padding:3px;">
													...
													<td align="center">
														<a href="javascript:void(0);" onclick="javascript:modComment('<? if(isset($tab_com['perso']['current']['id'])) echo $tab_com['perso']['current']['id']; else echo ''; ?>', '<? echo $ent->fields['id']; ?>', '<? if(empty($tab_com['perso']['current']['id'])) echo '3'; else echo ''; ?>');">
															<img src="./common/img/add.gif" title="<?php echo $_DIMS['cste']['_DIMS_TITLE_ADD_COMM']?>"/>
														</a>
														<?
															if(isset($tab_com['perso'])) {
																if($_SESSION['dims']['userid'] == $tab_com['perso']['current']['id_user']) {
														?>
														<a href="javascript:void(0);" onclick="javascript:modCommentbyAuthor('<? if(isset($tab_com['perso']['current']['id'])) echo $tab_com['perso']['current']['id']; else echo ''; ?>', '<? echo $ent->fields['id']; ?>', '<? if(empty($tab_com['perso']['current']['id'])) echo '3'; else echo ''; ?>');">
															<img src="./common/img/edit.gif" title="<?php echo $_DIMS['cste']['_DIMS_TITLE_MODIFY_COMMENTAIRE']?>"/>
														</a>
														<?		}
															}
	...
	<tr>
		<td width="100%" align="center">
		<? echo $skin->open_simplebloc($_DIMS['cste']['_DIMS_LABEL_COMMENT_HIST'], "", "padding-left:15px;", "./common/img/widget_zoom.png", "26", "26", "-15px", "0px", "javascript:void(0);", "javascript:affiche_div('hist_comm');", ""); ?>
				...
				<tr>
					<td align="center">
						...
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr>
								<td colspan="3">
									<div id="affiche_hcom_1" style="display:<? if(!empty($tab_com['generique']['historique'])) echo "block"; else echo "none"; ?>;width:100%;height:160px;overflow:auto;">
											...
											<tbody>
												...
												?>
													<tr class="trl1" style="font-size:12px;">
														...
														<td style="width: 53%;"><? echo $_DIMS['cste']['_DIMS_COMMENTS']; ?></td>
														<td style="width: 27%;"><? echo $_DIMS['cste']['_AUTHOR'] ?></td>
														<td style="width: 4%;"></td>
													</tr>
												<?
														$class_col = 'trl1';
														foreach($tab_com['generique']['historique'] as $key => $inf_com) {
															...
															echo '	<tr class="'.$class_col.'">
																		<td></td>
																		<td>'.$date_on['date'].'</td>
																		<td>'.substr($inf_com['commentaire'], 0,45).'... </td>
																		...
																		<td align="center"><a href="javascript:void(0);" onclick="javascript:affiche_div(\'div_hgen_'.$key.'\');"><img src="./common/img/view.png" title="'.$_DIMS['cste']['_DIMS_OBJECT_DISPLAY'].'"></a></td>
																	</tr>
																	<tr class="'.$class_col.'">
																		<td colspan="5">
						...
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr>
								<td colspan="3">
									<div id="affiche_hcom_2" style="display:<? if(!empty($tab_com['metier']['historique'])) echo "block"; else echo "none"; ?>;width:100%;height:160px;overflow:auto;">
										<table cellspacing="0" cellpadding="0" width="100%" style="border:#738CAD 1px solid;margin-top:10px;margin-bottom:10px;">
											<tbody>
												<?
												...
												<?
														...
														foreach($tab_com['metier']['historique'] as $key => $inf_com) {
															...
															echo '	<tr class="'.$class_col.'">
																		...
																		<td>'.substr($inf_com['commentaire'], 0,45).'... </td>
																		<td><a href="admin.php?cat='._BUSINESS_CAT_CONTACT.'&action='._BUSINESS_TAB_CONTACT_FORM.'&part='._BUSINESS_TAB_CONTACT_IDENTITE.'&contact_id='.$ct_creat->fields['id'].'">'.$ct_creat->fields['firstname'].' '.$ct_creat->fields['lastname'].'</a></td>
																		<td align="center"><a href="javascript:void(0);" onclick="javascript:affiche_div(\'div_hmet_'.$key.'\');"><img src="./common/img/view.png" title="'.$_DIMS['cste']['_DIMS_OBJECT_DISPLAY'].'"></a></td>
																	</tr>
																	<tr class="'.$class_col.'">
																		<td colspan="5">
												...
												<?
														...
														foreach($tab_com['perso']['historique'] as $key => $inf_com) {
															...
															echo '	<tr class="'.$class_col.'">
																		...
																		<td><a href="admin.php?cat='._BUSINESS_CAT_CONTACT.'&action='._BUSINESS_TAB_CONTACT_FORM.'&part='._BUSINESS_TAB_CONTACT_IDENTITE.'&contact_id='.$ct_creat->fields['id'].'">'.$ct_creat->fields['firstname'].' '.$ct_creat->fields['lastname'].'</a></td>
																		<td align="center"><a href="javascript:void(0);" onclick="javascript:affiche_div(\'div_hpers_'.$key.'\');"><img src="./common/img/view.png" title="'.$_DIMS['cste']['_DIMS_OBJECT_DISPLAY'].'"></a></td>
																	</tr>
																	<tr class="'.$class_col.'">
																		<td colspan="5">
