...
echo $skin->open_simplebloc($_DIMS['cste']['_DOCS'].' '.$_DIMS['cste']['_LABEL_PROJECTS']);
...
echo $skin->open_simplebloc($_DIMS['cste']['_DOCS'].' '.$_DIMS['cste']['_DIMS_LABEL_PHASE'].'/'.$_DIMS['cste']['_DIMS_TASKS']);
