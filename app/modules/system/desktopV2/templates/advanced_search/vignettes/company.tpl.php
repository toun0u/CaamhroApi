	...
	<div>
		<span class="label">
			...
			if ($mode == 'concept') {
				...
				?>
				<a class="remove_item" href="/admin.php?dims_op=desktopv2&action=as_managefilter&faction=del&type=company&val=<?php echo $this->fields['id_globalobject'];?>" title="delete this filter">
				<?php
			}
			?>
				<span><?php echo dims_strcut($this->getIntitule(), 15); ?></span>
			</a>
		</span>
	</div>
</div>
