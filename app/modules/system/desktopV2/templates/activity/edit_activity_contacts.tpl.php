<?
if (!isset($_SESSION['desktopv2']['activity']['ct_added'])) $_SESSION['desktopv2']['activity']['ct_added'] = array();
?>

<div class="title_description">
	<h2>
		<?php echo $_SESSION['cste']['CONTACT___COMPANIES_CONCERNED_BY_THE_EVENT']; ?>
	</h2>
...
<!--			<div class="searchform">
 ...
 -->
		...
		<div id="div_list_added" style="max-height:600px;overflow-x: hidden;overflow-y: auto;">
			<?php
			global $desktop;
			$added_contact = $desktop->constructLstTiersFromCt(array(),$_SESSION['desktopv2']['opportunity']['ct_added'], $_SESSION['desktopv2']['opportunity']['tiers_added']);
