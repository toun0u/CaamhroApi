<table style="width: 100%; border-collapse: collapse;border-bottom:1px solid #D6D6D6">
	<tbody>
		<tr>
			...
			<td>
				<img onclick="javascript:linkExistingContact(<?php echo $this->fields['id']; ?>, <?php echo $_SESSION['desktopv2']['activity']['tiers_selected']; ?>)" src="<?php echo _DESKTOP_TPL_PATH; ?>/gfx/common/add.png" style="float:left;cursor:pointer;" />
			</td>
	</tbody>
</table>
