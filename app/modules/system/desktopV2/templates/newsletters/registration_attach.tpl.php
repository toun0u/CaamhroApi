...
echo dims_create_button($_DIMS['cste']['_DIMS_BACK'], './common/img/undo.gif', 'javascript:document.location.href=\''.$scriptenv.'?news_op='.dims_const_desktopv2::_FICHE_NEWSLETTER.'\'');
...
<form name="attach_inscr" method="post" action="<?php echo $scriptenv; ?>?news_op=<?php echo dims_const_desktopv2::_NEWSLETTER_ATTACH_REGISTRATION_SAVE; ?>">
	<?
