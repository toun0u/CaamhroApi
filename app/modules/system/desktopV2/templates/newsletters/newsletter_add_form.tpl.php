<?php
require_once  _DESKTOP_TPL_LOCAL_PATH.'/newsletters/back_management.tpl.php';
...
?>
<div class="title_groups_news"><span><? echo $title;?></span></div>
<div style="float:left;width:100%;">
	...
	<?php
		...
		$token->field("news_id_user_responsible", $id_news);
		$token->field("id_news");
	...
	?>
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td width="80%" style="padding-left:25px;padding-top:25px;">
					<table width="100%" cellpadding="0" cellspacing="5">
						...
						<tr>
							...
							<td>
								<input style="width:400px;" type="text" id="fck_news_label" name="fck_news_label" <? if(isset($id_news) && $id_news != '') echo 'value="'.html_entity_decode($inf_news->fields['label']).'"'; ?> />
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								...
								dims_fckeditor("news_descriptif",$content,"900","350");
								?>
							</td>
						</tr>
						<tr>
							<td align="right">
								<?php echo $_DIMS['cste']['_DIMS_LABEL_MAILINGLIST_ADDRESS']; ?>&nbsp;
							</td>
							<td>
