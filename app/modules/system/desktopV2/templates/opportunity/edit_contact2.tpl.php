...
<div class="new_company_contact" style="display:block;">
        ...
        <table cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    ...
                    <td>
                        <input style="width: 98%;" type="text" name="civilite"value="<? echo $this->fields['civilite']; ?>"/>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input style="width: 98%;" type="text" name="lastname" value="<? echo $this->fields['lastname']; ?>"/>
                    </td>
                </tr>
				<tr>
                    <td class="text">
                    ...
                    <td>
                        <input style="width: 98%;" type="text" name="firstname"  value="<? echo $this->fields['firstname']; ?>"/>
                    </td>
                </tr>
                <!--<tr>
                    <td class="text">
                        <? echo $_SESSION['cste']['NICKNAME']; ?>
                    </td>
                    <td>
                        <input type="text" name="nickname" style="width: 98%;" type="text" value="<? if (isset($this->fields['nickname'])) echo $this->fields['nickname']; ?>"/>
                    </td>
                </tr>-->
				<?php
				$employed = false;
                ...
                <tr>
                    <td colspan="2">
                        <div class="zone_contact_opportunity_enregistrement">
                            <input type="button" value="<? echo $_SESSION['cste']['_DIMS_LABEL_CANCEL']; ?>" onclick="javascript:document.getElementById('detail_search_ct2_<? echo $this->fields['id']; ?>').innerHTML='';" />
							<span> <? echo $_SESSION['cste']['_DIMS_OR']; ?> </span>
							<input onclick="javascript:saveOppModifyContact('detail_search_ct2_',<? echo $this->fields['id']; ?>,<? echo $this->getLightAttribute('id_tiers'); ?>);" type="button" value="<? echo $_SESSION['cste']['_DIMS_SAVE']; ?>" />
                        </div>
                    </td>
                </tr>
            </tbody>
