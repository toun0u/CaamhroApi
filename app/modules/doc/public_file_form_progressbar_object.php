...
if ($op == 'file_add') {
	...
	<div class="doc_versionlog_main">
		...
		<div class="doc_versionlog_main2">
			...
			<div style="right:240px;" class="doc_versionlog_column"></div>
...
if (!isset($currentfolder)) $currentfolder=-1;
?>
		...
		<div class="dims_form" style="padding:2px;">
			...
			if ($op == 'file_add') {
				...
				<div id="ScrollBox" style="overflow:auto;">
					...
					<iframe id="uploadForm" name="uploadForm" scrolling="No" style="visibility:hidden;height:250px;width:650px;" src=""></iframe>
				</div>
