...
switch($_SESSION['share']['etape']) {
	case 1:
		require_once(DIMS_APP_PATH . '/modules/sharefile/cms_share_etape1.php');
		break;
	case 2:
		...
		require_once(DIMS_APP_PATH . '/modules/sharefile/cms_share_etape2.php');
		break;
	case 3:
		require_once(DIMS_APP_PATH . '/modules/sharefile/cms_share_etape3.php');
		break;
}
