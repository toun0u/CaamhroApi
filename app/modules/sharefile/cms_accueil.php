<div style="width:100%">
	<table style="width:100%;">
		<tr>
			<td style="width:5%"><img src="/common/modules/sharefile/img/send.png"></td>
			<td style="width:30%"><a href="<? echo dims_urlencode("index.php?op=add_share&reset=1"); ?>">Nouveau partage</a></td>
			<td style="width:5%"><img src="/common/modules/sharefile/img/contacts.png"></td>
		...
		if (dims_isadmin()) {
			...
			echo '<td style="width:5%"><img src="/common/modules/sharefile/img/properties.png"></td>';
