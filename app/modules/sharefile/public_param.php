...
<div class="dims_form" style="float:left; width:80%;padding-top:20px;">
	<div style="padding:2px;clear:both;float:left;width:100%;">
		...
		<p>
			...
			<?
			require_once(DIMS_APP_PATH . '/www/common/js/ckeditor/ckeditor.php') ;

			$basepath = dirname($_SERVER['HTTP_REFERER']); // compatible with proxy rewrite
			if ($basepath == '/') $basepath = '';

			$oFCKeditor = new CKEditor("{$basepath}/common/js/ckeditor/") ;

			$oFCKeditor->BasePath	= "{$basepath}/common/js/ckeditor/";
			...
			$oFCKeditor->Config['CustomConfigurationsPath'] = "{$basepath}/common/modules/system/fckeditor/fckconfig.js"  ;
			//$oFCKeditor->Config['ToolbarLocation'] = 'Out:xToolbar' ;
			$oFCKeditor->Config['SkinPath'] = "{$basepath}/common/modules/system/fckeditor/skins/default/" ;
			$oFCKeditor->Config['EditorAreaCSS'] = "{$basepath}/common/modules/system/fckeditor/fck_editorarea.css" ;
			$oFCKeditor->Config['BaseHref'] = "http://{$_SERVER['HTTP_HOST']}{$basepath}/common/";
			$oFCKeditor->editor('fck_share_param_send_message') ;
?>
		</p>
		<p>
			...
			$oFCKeditor->Config['EditorAreaCSS'] = "{$basepath}/common/modules/system/fckeditor/fck_editorarea.css" ;
			$oFCKeditor->Config['BaseHref'] = "http://{$_SERVER['HTTP_HOST']}{$basepath}/common/";
			$oFCKeditor->editor('fck_share_param_message') ;
?>
		</p>
	</div>
