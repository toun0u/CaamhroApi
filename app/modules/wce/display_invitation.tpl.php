...
unset($params['md5']);
unset($params['object']);
$md5Contact = current(array_keys($params));

$obj->setLightAttribute('save',dims_load_securvalue('save',dims_const::_DIMS_NUM_INPUT,true,true));
$obj->setLightAttribute('propositions',$obj->getDatesLink());
$obj->setLightAttribute('contact',$contact);
ob_clean();
if (file_exists(DIMS_APP_PATH."templates/frontoffice/$template_name/wce_invitation.php"))
	$obj->display(DIMS_APP_PATH."templates/frontoffice/$template_name/wce_invitation.php");
else
	$obj->display(DIMS_APP_PATH."/modules/invitation/wce_invitation.php");
