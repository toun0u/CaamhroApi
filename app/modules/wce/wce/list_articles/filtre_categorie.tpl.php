<?php
if(!isset($_SESSION['wce']['lst_article']['categ'])) $_SESSION['wce']['lst_article']['categ'] = 0;
$id_categ = dims_load_securvalue('id_categ',dims_const::_DIMS_NUM_INPUT,true,true,false,$_SESSION['wce']['lst_article']['categ'],$_SESSION['wce']['lst_article']['categ']);
