...
window['updateCompleteArticle'] = function updateCompleteArticle(param) {
	...
	window['wceAddBlock'] = function wceAddBlock(section,lang) {
		...
		dims_xmlhttprequest_todiv('admin.php','dims_op=add_block&section='+section+"&lang="+lang,'','dims_popup');
	}


	window['wceModifBlock'] = function wceModifBlock(blockid,lang) {
		dims_showcenteredpopup("",700,'','dims_popup');
		dims_xmlhttprequest_todiv('admin.php','dims_op=modify_block&block_id='+blockid+"&lang="+lang,'','dims_popup');
	}
	...
	window['wceModifBlockContent'] = function wceModifBlockContent(blockid,contentid) {
