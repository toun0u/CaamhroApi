...
$listnewfolders = $view->get('listnewfolders');
?>
...
if(!empty($documents) || !empty($folders) || !empty($listnewfolders)){
	?>
	<div id="list-of-documents">
		...
		if (!empty($listnewfolders)) {
			foreach($listnewfolders as $categ){
				$view->partial($view->getTemplatePath('documents/_folder_new.tpl.php'), $categ);
			}
		}
		?>
	</div>
