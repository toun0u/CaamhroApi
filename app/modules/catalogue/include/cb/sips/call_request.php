...
$parm="merchant_id=011223344551112";
$parm="$parm merchant_country=fr";
$parm="$parm amount=".$_SESSION['catalogue']['total_ttc'] * 100; // en cents
...
$parm="$parm pathfile=".realpath('.').'/modules/catalogue/include/cb/sips/param/pathfile';
...
//		$parm="$parm target=";
$parm="$parm order_id=".$_SESSION['catalogue']['id_cde'];
...
$path_bin = realpath('.').'/modules/catalogue/include/cb/sips/bin/request';
