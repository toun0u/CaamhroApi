	...
	<div class="sub_bloc_form">
		<table>
			...
			foreach ($view->get('languages') as $id_lang => $lang) {
				?>
				<tr <?= (!$first)?'style="display:none"':''; ?> class="template_title title_<?= $id_lang; ?>">
			...
			?>
			<tr>
				<td class="label_field"><label for="template_doc"><?= $this->get_field_label('template_doc'); ?></label></td>
				<td class="value_field"><?= $this->get_field_html('template_doc'); ?></td>
			</tr>
		</table>
	</div>
</div>
