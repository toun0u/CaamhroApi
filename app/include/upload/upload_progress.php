...
***************************************************************************************************/
	...
	if (isset($_SESSION['dims']['uploaded_sid'])) $sid=$_SESSION['dims']['uploaded_sid'];
	else die();
...
//***** Check if session temp dir has been created, if so file has either started uploading or finished
		if (is_dir($session_dir)) {
			//echo $upload_finished_file;
			if (!file_exists($upload_finished_file)) {
