<?php
// PUBLIC SETTINGS
$tmpdir = DIMS_TMP_PATH;	// your PHP temporary upload folder ( without last slash )
...
require(DIMS_APP_PATH . '/modules/doc/UploadProgressManager.class.php');			// The class UploadProgressManager class
