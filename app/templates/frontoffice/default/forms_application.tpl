<form name="form_display" action="" method="post" enctype="multipart/form-data" onsubmit="javascript:return form_validate(this);">
<input type="hidden" name="op2" value="saveform">
	...
	<div class="form_row" style="margin-top:{formfields.switch_field.INTERLINE}px;">
		...
		<span class="field">
			...
			<!-- BEGIN switch_radio -->
				<!-- BEGIN values -->
				<div>
					<div class="form_checkzone"><input {formfields.switch_field.switch_radio.values.CHECKED} type="radio" class="form_checkbox" name="{formfields.switch_field.switch_radio.values.NAME}" value="{formfields.switch_radio.switch_select.values.VALUE}"></div>
