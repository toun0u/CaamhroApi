<?php
$website_name = 'Caahmro';
$expeditor = 'ne_pas_repondre@caahmro.fr';
						...
						<tr>
						  <td>
							<table>
							  ...
							  <tr>
								<td><strong>Référence de commande :</strong></td>
								<td>".(($this->getLibelle() != '') ? $this->getLibelle() : '<em>Non renseigné</em>')."</td>
							  </tr>
							  <tr>
