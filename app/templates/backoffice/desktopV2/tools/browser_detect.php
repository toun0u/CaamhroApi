<?
	...
	function IsIE() {
		...
		return (BrowserDetect('browser') == 'ie') ? 1 : 0 ;
	}


	function IsIE6() {

		return (IsIE() && (BrowserDetect('number') < 7)) ? 1 : 0 ;
	}


	function IsIE7() {

		return (IsIE() && (BrowserDetect('number') >= 7) && (BrowserDetect('number') < 8)) ? 1 : 0 ;
	}


	function IsIE8() {

		return (IsIE() && (BrowserDetect('number') >= 8) && (BrowserDetect('number') < 9)) ? 1 : 0 ;
	}


	function IsFx() {

		return (BrowserDetect('browser') == 'moz') ? 1 : 0 ;
	}


	function IsSaf() {

		return (BrowserDetect('browser') == 'saf') ? 1 : 0 ;
	}
	...
	*/
	...
	function BrowserDetect( $which_test )
	{
		...
		for ($i = 0; $i < count($a_browser_types); $i++)
		{
			...
			if (stristr($browser_user_agent, $s_browser))
			{
				...
				$browser_number = GetBrowserVersion( $browser_user_agent, $s_browser );
				break;
			}
		}
	...
	function GetBrowserVersion( $browser_user_agent, $search_string )
	{
