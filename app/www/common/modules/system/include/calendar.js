...
function PopupWindow_showPopup(anchorname) {
 ...
 if (this.divName != null) {
	 ...
	 if (this.use_gebi) {
	 document.getElementById(this.divName).style.left = (this.x + 140)+"px";
	 document.getElementById(this.divName).style.top = (this.y + 130)+"px";
	 ...
	 document.layers[this.divName].visibility = "visible";
		 ...
		 document.getElementById(this.divName).style.left = this.x + 140;
		document.getElementById(this.divName).style.top = this.y + 130;
		document.getElementById(this.divName).style.visibility = "visible";
	 }
 }
 else {
...
function CP_getCalendar() {
 ...
 result += '<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="22"><A CLASS="'+this.cssPrefix+'cpMonthNavigation" HREF="'+refresh+'('+this.index+','+last_month+','+last_month_year+');"><IMG BORDER=0 WIDTH=16 HEIGHT=16 SRC="./common/modules/forms/img/prev.gif"></A></TD>\n';
 result += '<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="100"><SPAN CLASS="'+this.cssPrefix+'cpMonthNavigation">'+this.monthNames[month-1]+' '+year+'</SPAN></TD>\n';
 result += '<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="22"><A CLASS="'+this.cssPrefix+'cpMonthNavigation" HREF="'+refresh+'('+this.index+','+next_month+','+next_month_year+');"><IMG BORDER=0 WIDTH=16 HEIGHT=16 SRC="./common/modules/forms/img/next.gif"></A></TD>\n';
 }
 result += '</TR></TABLE>\n';
