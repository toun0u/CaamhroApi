...
var fr = {
		toolbar	: 'Video',
		dialogTitle : 'Propriétés de la video',
		fakeObject : 'Vid"o',
		properties : 'Editione de la vid"o',
		widthRequired : 'Le champ largeur ne peut être vide',
		heightRequired : 'Le champ hauteur ne peut être vide',
		poster: 'Choix de l\'image',
		sourceVideo: 'Source video',
		sourceType : 'Format',
		linkTemplate :  '<a href="%src%">%type%</a> ',
		fallbackTemplate : 'Votre navigateur ne supporte pas le format de cette vidéo.<br>Vous pouvez la télécharger : %links%'
	};
