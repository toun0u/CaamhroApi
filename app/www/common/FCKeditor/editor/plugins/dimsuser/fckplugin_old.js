...
//FCKCommands.RegisterCommand( 'DimsObjects'	, new FCKDialogCommand( FCKLang['DlgDimsObjectsTitle']	, FCKLang['DlgDimsObjectsTitle']		, FCKConfig.PluginsPath + 'dimsobjects/dimsobjects.php'	, 340, 170 ) ) ;
FCKCommands.RegisterCommand( 'DimsObjects'	, new FCKDialogCommand( FCKLang['DlgDimsObjectsTitle']	, FCKLang['DlgDimsObjectsTitle']		, FCKConfig.BaseHref + 'index-light.php?op=get_dimsobjects'	, 340, 170 ) ) ;
// Create the "Find" toolbar button.
var oDimsObjects		= new FCKToolbarButton( 'DimsObjects', FCKLang['DlgMyFindTitle'] ) ;
