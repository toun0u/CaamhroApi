...
FCKCommands.RegisterCommand( 'DimsObjects'	, new FCKDialogCommand( FCKLang['DlgDimsObjectsTitle']	, FCKLang['DlgDimsObjectsTitle']		, FCKConfig.BaseHref + 'admin-light.php?dims_op=wce_getdimsobjects'	, 450, 240 ) ) ;
