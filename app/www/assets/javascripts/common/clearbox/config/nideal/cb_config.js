...
// CB layout:
	...
	CB_WindowColor='#242424',			// color of the CB window (note: you have to change the rounded-corner PNGs too!), transparent is also working
	...
	CB_Padd=20,					// padding around inside the CB window
...
// CB font, text and navigation (at the bottom of CB window) settings:
	...
	CB_TextH=20,					// default height of the text area under the content in CB window (adding a comment will modify this setting), if you change the font sizes, you maybe have to change this setting
...
// Images using by CB settings:
	...
	CB_PictureStart='blank.gif',			// start.png
	CB_PicturePause='blank.gif',			// pause.png
