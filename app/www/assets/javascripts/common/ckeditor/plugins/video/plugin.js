...
CKEDITOR.plugins.setLang( 'video', 'fr', { video :
	{
		toolbar	: 'Vidéo',
		dialogTitle : 'Propriétés de la vidéo',
		fakeObject : 'Vidéo',
		properties : 'Éditer vidéo',
		widthRequired : 'Le champ largeur ne peux être vide',
		heightRequired : 'Le champ hauteur ne peux être vide',
		poster: 'Image à afficher',
		sourceVideo: 'Source de la vidéo',
		sourceType : 'Type de vidéo',
		linkTemplate :  '<a href="%src%">%type%</a> ',
		fallbackTemplate : 'Votre navigateur ne supporte pas la vidéo.<br />Veuillez télécharger le fichier : %links%'
