...
CKEDITOR.editorConfig = function( config )
{
	...
	[
		...
		{ name: 'insert', items : [ 'Image','Flash','Table','dimsobjects','Youtube','MediaEmbed','Iframe']},
	...
	config.extraPlugins = 'ajaxsave,ajaxclose,ajax,removespace,youtube,scayt,dimsobjects,syntaxhighlight','Iframe'; // ,wiki,dimsobjects,devtools
